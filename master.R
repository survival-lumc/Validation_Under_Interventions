...
scenario<-1; cindex_ylim_low <- .48; cindex_ylim_high <- .625; auc_ylim_low <- 0.46; auc_ylim_high <- 0.70; calib_lim_low <- 0.40; calib_lim_high <- 0.9; calib_risk_lim_high <- 0.85; model <- " additive hazards model"
...
ggsave(descr_KM_plot,file=paste0("results_cox\\cox_marginal_risk_distribution","scenario_", scenario,".png"),width = 20/2, units = "cm")
